...
export interface StrategyResult {
    ...
    lastImageForGeneration?: string | null;
...
export const processFrameWeaver = async (
    ...
    if (inputImages.length >= 2) {
        ...
        lastImage = inputImages[inputImages.length - 1];
    ...
    return {
        finalPrompt,
        videoInput: null,
        inputImageForGeneration: inputImage, 
        lastImageForGeneration: lastImage,
        referenceImages: undefined, // Clear references to ensure Start/End logic
